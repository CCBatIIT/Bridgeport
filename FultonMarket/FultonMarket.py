...
class FultonMarket():
    ...
    def _configure_experiment_parameters(self):
        ...
        assert [len(os.listdir(os.path.join(self.save_dir, dir))) == 4 for dir in os.listdir(self.save_dir)].all(), "You may have an empty save directory, please remove empty or incomplete save directories before continuing :)"
